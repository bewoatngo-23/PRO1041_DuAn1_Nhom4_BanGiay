...
//        String sql = "   								 SELECT dbo.ChiTietSP.Id, dbo.SanPham.Ma, dbo.SanPham.Ten, dbo.HoaDonChiTiet.SoLuong, dbo.HoaDonChiTiet.DonGia\n"
...
//            while (rs.next()) {
//                listHDCTDT.add(new HDCTDoiTraCustomModel(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getDouble(5)));
//            }
//            return listHDCTDT;
//        } catch (Exception e) {
//            e.getMessage();
