...
//vu_ctsp
    ...
    public ChiTietSanPhamHiber getForm() {
        ...
        return new ChiTietSanPhamHiber(null,
                ...
                ngay,
                Double.parseDouble(txt_giaBan.getText().replace(".", "")),
    ...
    public boolean checkDL() {
        ...
        if (uti.CheckSoAm(Integer.valueOf(txt_giaBan.getText().replace(".", "")))) {
        ...
        if (uti.CheckSoAm(Integer.valueOf(txt_soLuong.getText()))) {
...
//        }
    ...
    public boolean CheckSdtKH() {
        if (khs.CheckSDT(txtSdt.getText())) {
            JOptionPane.showMessageDialog(this, "Số điện thoại bị trùng, vui lòng nhập sdt khác");
            txtSdt.requestFocus();
            return true;
        }
        return false;
    ...
    public boolean CheckTK() {
        if (nhanVienServiceImpl.CheckTK(txtTaiKhoan.getText())) {
            JOptionPane.showMessageDialog(this, "Tên tài khoản bị trùng, vui lòng nhập tài khoản khác");
            txtMa.requestFocus();
            txtMa.setText("");
            return true;
        }
    ...
    public boolean CheckSdtNV() {
        if (nvs.CheckSDT(txtSdtNV.getText())) {
            JOptionPane.showMessageDialog(this, "Số điện thoại bị trùng, vui lòng nhập sdt khác");
            txtSdtNV.requestFocus();
            return true;
        }
    ...
    private void initComponents() {
        ...
        jLabel85.setForeground(new java.awt.Color(11, 42, 61));
        jLabel85.setText("Hóa đơn chờ");

        jLabel86.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel86.setForeground(new java.awt.Color(11, 42, 61));
        jLabel86.setText("Quét mã sản phẩm");
    ...
    private void btnAddNVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNVActionPerformed
        if (txtNgaySinh.getDate() == null) {
            ...
            if (CheckDLNV() == false && CheckTrungMaNV() == false && CheckSdtNV() == false && CheckTK() == false) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (txtNgaySinhKH.getDate() == null) {
            ...
            if (CheckDLKH() == false && CheckTrungMaKH() == false && CheckSdtKH() == false) {
                var temp = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn thêm mới");
                if (temp == 0) {
    ...
    private void tbl_CTSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_CTSanPhamMouseClicked
        ...
        txt_giaBan.setText(String.valueOf(temp.getDonGia()).replace(".", ""));
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        if (temp == 0) {
            ...
            try {
                ...
                Logger.getLogger(HomeNhanVien.class
                        .getName()).log(Level.SEVERE, null, ex);
            }
